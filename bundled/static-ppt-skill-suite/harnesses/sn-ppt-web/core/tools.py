...
PTY mode: Set pty=true for interactive CLI tools (Codex, Python REPL, and similar tools).
...
TERMINAL_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "pty": {"type": "boolean", "description": "Run in pseudo-terminal (PTY) mode for interactive CLI tools like Codex or Python REPL. Only works with local and SSH backends. Default: false.", "default": False},
